...
function tripleTheFun(peram){
	newPeram = peram + peram + peram
	if( peram == Number(peram)){
	  return Number(peram) + Number(peram) + Number(peram)
	}
	return newPeram
}
